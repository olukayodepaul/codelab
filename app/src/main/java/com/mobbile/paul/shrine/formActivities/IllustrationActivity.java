...
public class IllustrationActivity extends AppCompatActivity {
    ...
    RadioButton twoDRadioButton, threeDRadioButton;
    AppCompatButton upload_button;
    String illustrationName = "";
    String illustrationDescription = "";
    String illustrationType = TWO_D_OPTION;
    String illustrationUrl = "";


    private static String TWO_D_OPTION ="2D";
    private static String THREE_D_OPTION ="3D";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).asGif().load(R.raw.illustration).into(backdrop);


        if (!checkPermissions()) {
            Toast.makeText(this, "Permission needs to be granted to upload a character", Toast.LENGTH_LONG).show();
        }

        nameEditText = findViewById(R.id.nameEditText);
        descriptionEditText = findViewById(R.id.descriptionEditText);
        threeDRadioButton = findViewById(R.id.threeDRadioButton);
        twoDRadioButton = findViewById(R.id.twoDRadioButton);
        ...
        IllustrationAdapter illustrationAdapter = new IllustrationAdapter();
...
//                            displayPaymentView();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent fileReturnedIntent) {
        ...
        if (requestCode == SELECT_PHOTO) {
            if (resultCode == RESULT_OK) {
                ...
                final StorageReference storageReference = storageRef.child("illustration/" + file.getLastPathSegment());
                ...
                uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            illustrationUrl = downloadUri.toString();
                            ...
                            int color = ContextCompat.getColor(IllustrationActivity.this, R.color.colorWarmGreenBackground);
    ...
    private void requestIllustration() {
        ...
        illustrationName = Objects.requireNonNull(nameEditText.getText()).toString();
        illustrationDescription = Objects.requireNonNull(descriptionEditText.getText()).toString();

        if (twoDRadioButton.isChecked()){
            illustrationType = TWO_D_OPTION;
        }
        else {
            illustrationType = THREE_D_OPTION;
        }
        ...
        data.put("illustrationName", illustrationName);
        data.put("illustrationDescription", illustrationDescription);
        data.put("illustrationType", illustrationType);
        data.put("illustrationUrl", illustrationUrl);
    ...
    private void displaySuccessRequest(String uniqueId) {
        ...
        intent.putExtra(ARGS_ORDER_AMOUNT, 1000);
